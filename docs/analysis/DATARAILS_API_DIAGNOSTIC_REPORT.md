...
- **Endpoint:** `POST https://app.datarails.com/finance-os/api/tables/v1/TABLE_ID/data`
...
curl -X POST "https://app.datarails.com/finance-os/api/tables/v1/TABLE_ID/data" \
