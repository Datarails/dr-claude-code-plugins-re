...
- **Claude Desktop:** Try to suggest the connector via the MCP registry. If not available, tell them: click "+" next to the prompt > Connectors > find Datarails > Connect (or Settings > Connectors)
