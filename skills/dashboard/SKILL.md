---
name: dr-dashboard
description: ONE-MONTH KPI snapshot for the latest closed month — Excel dashboard + single-slide PowerPoint one-pager. For a full-fiscal-year narrative deck use insights; for a year-long analysis workbook use intelligence; for a raw data export use extract.
user-invocable: true
allowed-tools:
