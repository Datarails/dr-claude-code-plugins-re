---
name: dr-insights
description: FULL-FISCAL-YEAR narrative deck — multi-slide PowerPoint plus a supporting Excel data book, with trend analysis and charts. For a one-month KPI snapshot use dashboard; for a 10-sheet analysis workbook (no PowerPoint) use intelligence.
user-invocable: true
allowed-tools:
