...
lives in the `datarails-financeos:anomalies` skill. Do not improvise workflow steps here.

Invoke the **`datarails-financeos:anomalies`** skill with the user's arguments (a table name or
